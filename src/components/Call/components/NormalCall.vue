<template>
  <div class="call-handler">
    <div class="call-handler-contents">
      ...
      <h6>
        {{ caller_number }}
        <span :state="time" v-if="call_state == 'CONNECTED'"
      ...
      <div class="call-handle-buttons-container">
        <b-button
          size="sm"
          @click="OnholdToggleInitialCall()"
          id="tooltip-target-hold"
          pill
          class="call-control-buttons"
          :variant="hold_status ? 'warning' : 'secondary'"
        >
          <font-awesome-icon :icon="hold_status ? 'play' : 'pause'" size="sm" />
        </b-button>
        <b-tooltip
          target="tooltip-target-hold"
          triggers="hover"
          noninteractive="true"
          placement="bottom"
          >Hold/Play</b-tooltip
        ...
        <b-button
          size="sm"
          @click="OnMuteToggle()"
          id="tooltip-target-mute"
          pill
          class="call-control-buttons"
          :variant="mute_status ? 'primary' : 'secondary'"
        >
          <font-awesome-icon
            :icon="mute_status ? 'microphone-alt-slash' : 'microphone-alt'"
            size="sm"
          />
        </b-button>
        <b-tooltip
          target="tooltip-target-mute"
          triggers="hover"
          noninteractive="true"
          placement="bottom"
          >Mute</b-tooltip
        ...
        <b-button
          size="sm"
          @click="OnDialPadToggle()"
          id="tooltip-target-dp"
          pill
          class="call-control-buttons"
          variant="secondary"
        >
        ...
        <b-tooltip
          target="tooltip-target-qc"
          triggers="hover"
          noninteractive="true"
          placement="bottom"
          >Quick Connect</b-tooltip
        >

        <b-button
          @click="OnEndIntialCall()"
          id="tooltip-target-ec"
          class="call-handle-buttons"
          size="sm"
          variant="danger"
        >
