  ...
  <div class="content-container">
    <div v-if="callSubNav == 'call'">
      <div v-if="call_type == 'normal'">
        ...
        <normal-call
          v-if="
            (call_state == 'CONNECTED' || outboundCall) && call_state != 'ACW'
          "
        ></normal-call>
        <after-call-work
          v-if="call_state == 'ACW' || call_state == 'MISSED'"
        ></after-call-work>
      </div>
      ...
      <div v-if="call_state != 'MISSED'">
        <utilities style="margin-top: 5px"></utilities>
      </div>

      <div v-if="caller_name == 'Unknown Caller'">
        <create-contact style="margin-top: 5px"></create-contact>
      </div>
    </div>
